...
namespace ImageProcess2
{
	...
	public class BitmapFilter
	{
		...
		public static bool Brightness(Bitmap b, int nBrightness)
		{
			...
			int stride = bmData.Stride;  //the actual width after 24 bit compression
			System.IntPtr Scan0 = bmData.Scan0;
			...
			unsafe
			{
				...
				for (int y = 0; y < b.Height; ++y)
				{
					for (int x = 0; x < nWidth; ++x)
					{
						nVal = (int)(p[0] + nBrightness); /// 200 -255
		...
		public static void Threshold(ref Bitmap a, ref Bitmap b, int t)
		{
		...
		public static void NegativeThreshold(ref Bitmap a, ref Bitmap b, int t)
		{
			b = new Bitmap(a.Width, a.Height);
			for (int x = 0; x < a.Width; x++)
			{
		...
		public static bool Color1(Bitmap b, int red, int green, int blue)
		{
